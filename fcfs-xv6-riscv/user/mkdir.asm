...
main(int argc, char *argv[])
{
  ...
  4c:	7e858593          	addi	a1,a1,2024 # 830 <malloc+0xfe>
  50:	4509                	li	a0,2
  52:	00000097          	auipc	ra,0x0
  56:	5f6080e7          	jalr	1526(ra) # 648 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
  ...
  6a:	7e258593          	addi	a1,a1,2018 # 848 <malloc+0x116>
  6e:	4509                	li	a0,2
  70:	00000097          	auipc	ra,0x0
  74:	5d8080e7          	jalr	1496(ra) # 648 <fprintf>
      break;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	4d280813          	addi	a6,a6,1234 # 8c8 <digits>
 3fe:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f6:	37e70713          	addi	a4,a4,894 # 870 <malloc+0x13e>
 ...
 584:	348b8b93          	addi	s7,s7,840 # 8c8 <digits>
 ...
 5da:	29290913          	addi	s2,s2,658 # 868 <malloc+0x136>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bc:	6107b783          	ld	a5,1552(a5) # cc8 <freep>
 ...
 6c8:	00e6ea63          	bltu	a3,a4,6dc <free+0x30>
{
 ...
 70a:	5cf73123          	sd	a5,1474(a4) # cc8 <freep>
}
 70e:	60a2                	ld	ra,8(sp)
 710:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 754:	57853503          	ld	a0,1400(a0) # cc8 <freep>
 ...
 780:	54c48493          	addi	s1,s1,1356 # cc8 <freep>
  if(p == (char*)-1)
 784:	5afd                	li	s5,-1
 ...
 794:	54078793          	addi	a5,a5,1344 # cd0 <base>
 798:	00000717          	auipc	a4,0x0
 79c:	52f73823          	sd	a5,1328(a4) # cc8 <freep>
 7a0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 80e:	4aa73f23          	sd	a0,1214(a4) # cc8 <freep>
      return (void*)(p + 1);
