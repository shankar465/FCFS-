...
main(int argc, char *argv[])
{
  ...
  14:	80858593          	addi	a1,a1,-2040 # 818 <malloc+0xfe>
  18:	4509                	li	a0,2
  ...
  52:	7e258593          	addi	a1,a1,2018 # 830 <malloc+0x116>
  56:	4509                	li	a0,2
  58:	00000097          	auipc	ra,0x0
  5c:	5d8080e7          	jalr	1496(ra) # 630 <fprintf>
...
free(void *ap)
{
 ...
 6a4:	6087b783          	ld	a5,1544(a5) # ca8 <freep>
 ...
 6b0:	00e6ea63          	bltu	a3,a4,6c4 <free+0x30>
{
 ...
 6f2:	5af73d23          	sd	a5,1466(a4) # ca8 <freep>
}
 6f6:	60a2                	ld	ra,8(sp)
 6f8:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 73c:	57053503          	ld	a0,1392(a0) # ca8 <freep>
 ...
 768:	54448493          	addi	s1,s1,1348 # ca8 <freep>
  if(p == (char*)-1)
 76c:	5afd                	li	s5,-1
 ...
 77c:	53878793          	addi	a5,a5,1336 # cb0 <base>
 780:	00000717          	auipc	a4,0x0
 784:	52f73423          	sd	a5,1320(a4) # ca8 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f6:	4aa73b23          	sd	a0,1206(a4) # ca8 <freep>
      return (void*)(p + 1);
